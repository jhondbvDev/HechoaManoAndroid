...
import com.example.hechoamano.ui.stockcontrol.adapter.EmployeesAdapter
import com.example.hechoamano.ui.util.EmptyDataObserver
import dagger.hilt.android.AndroidEntryPoint
import java.util.Locale

@AndroidEntryPoint
class EmployeesStockControlActivity : BaseActionBarActivity() {

    private lateinit var binding: ActivityEmployeesProductEntryBinding

    private val employeeViewModel: EmployeesStockControlViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        employeeViewModel.navigateToProducts.observe(this, Observer { employee ->
            startActivity(ProductsStockControlActivity.getStartIntent(this, employee))
        })
