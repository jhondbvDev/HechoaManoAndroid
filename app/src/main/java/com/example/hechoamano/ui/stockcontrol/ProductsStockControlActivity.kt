...
import com.example.hechoamano.ui.stockcontrol.adapter.ProductsAdapter
import com.example.hechoamano.ui.util.EmptyDataObserver
import dagger.hilt.android.AndroidEntryPoint
import java.util.Locale

@AndroidEntryPoint
class ProductsStockControlActivity : BaseActionBarActivity() {

    private lateinit var binding: ActivityProductsCustomerOrderBinding

    private val productViewModel: ProductsStockControlViewModel by viewModels()
    ...
    companion object {
        ...
        fun getStartIntent(context: Context, employee: Employee): Intent {
            ProductsStockControlActivity.employee = employee
            return Intent(context, ProductsStockControlActivity::class.java)
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setActionBarTitle("Historial de Inventario - Productos")
        ...
        productViewModel.navigateToSummary.observe(this, Observer { products ->
            startActivity(SummaryStockControlActivity.getStartIntent(this, employee, products))
        })
